...
class CircuitBreaker(object):
    ...
    def __call__(self, arg):
        ...
        if self.check_state() == CIRCUIT_BREAKER_STATES.OPEN.value:
            current_timelapse = datetime.utcnow() - datetime.strptime(redis.get('_circuit_open_time'),'%B %d %Y - %H:%M:%S')
    ...
    def on_failure(self):
        ...
        self._failure_window_start_time = datetime.strptime(redis.get('_failure_window_start_time'),'%B %d %Y - %H:%M:%S')
